...
var toString = function toString() {
    ...
    if (!(typeof isThisArray === 'boolean')) {
        throw new TypeError('Value of variable "isThisArray" violates contract, expected bool got ' + (isThisArray === null ? 'null' : (typeof isThisArray === 'undefined' ? 'undefined' : _typeof(isThisArray)) === 'object' && isThisArray.constructor ? isThisArray.constructor.name || '[Unknown Object]' : typeof isThisArray === 'undefined' ? 'undefined' : _typeof(isThisArray)));
    }
        ...
        if (this.hasOwnProperty(_key4)) {
            if (!isFirst) {
                ...
                if (!(typeof string === 'string')) {
                    throw new TypeError('Value of variable "string" violates contract, expected string got ' + (string === null ? 'null' : (typeof string === 'undefined' ? 'undefined' : _typeof(string)) === 'object' && string.constructor ? string.constructor.name || '[Unknown Object]' : typeof string === 'undefined' ? 'undefined' : _typeof(string)));
                }
            }
