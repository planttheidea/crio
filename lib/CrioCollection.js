...
var CrioCollection = (function () {
    ...
    _createClass(CrioCollection, [{
        ...
        value: function setIn() {
            ...
            function _ref8(_id8) {
                if (!(_id8 == null || _id8 instanceof CrioCollection)) {
                    throw new TypeError('Function return value violates contract, expected ?CrioCollection got ' + (_id8 === null ? 'null' : (typeof _id8 === 'undefined' ? 'undefined' : _typeof(_id8)) === 'object' && _id8.constructor ? _id8.constructor.name || '[Unknown Object]' : typeof _id8 === 'undefined' ? 'undefined' : _typeof(_id8)));
                }
            ...
            return _ref8((0, _crioFunctions.getCrioInstance)(this, (0, _createNewCrio.createNewCrio)(updatedObject)));
        }
        ...
        value: function thaw() {
            function _ref9(_id9) {
                if (!(Array.isArray(_id9) || _id9 instanceof Object)) {
                    throw new TypeError('Function return value violates contract, expected Array | Object got ' + (_id9 === null ? 'null' : (typeof _id9 === 'undefined' ? 'undefined' : _typeof(_id9)) === 'object' && _id9.constructor ? _id9.constructor.name || '[Unknown Object]' : typeof _id9 === 'undefined' ? 'undefined' : _typeof(_id9)));
                }

                return _id9;
            }

            return _ref9((0, _crioFunctions.thaw)(this));
        }
        ...
        value: function toCollection() {
            function _ref10(_id10) {
                if (!(_id10 instanceof CrioCollection)) {
                    throw new TypeError('Function return value violates contract, expected CrioCollection got ' + (_id10 === null ? 'null' : (typeof _id10 === 'undefined' ? 'undefined' : _typeof(_id10)) === 'object' && _id10.constructor ? _id10.constructor.name || '[Unknown Object]' : typeof _id10 === 'undefined' ? 'undefined' : _typeof(_id10)));
                }

                return _id10;
            }

            return _ref10(this.mutate(function (mutableObject) {
                var collection = [];
        ...
        value: function toLocaleString() {
            ...
            return _ref11((0, _crioFunctions.convertToString)(this, true));
        }
        ...
        value: function toString() {
            ...
            return _ref12((0, _crioFunctions.convertToString)(this, false));
        }
