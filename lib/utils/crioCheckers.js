...
var isSameCrio = function isSameCrio(obj1, obj2) {
    if (!(obj1 instanceof _CrioCollection2.default || obj1 instanceof _CrioDate2.default)) {
        throw new TypeError('Value of argument "obj1" violates contract, expected CrioCollection | CrioDate got ' + (obj1 === null ? 'null' : (typeof obj1 === 'undefined' ? 'undefined' : _typeof(obj1)) === 'object' && obj1.constructor ? obj1.constructor.name || '[Unknown Object]' : typeof obj1 === 'undefined' ? 'undefined' : _typeof(obj1)));
    }

    if (!(obj2 instanceof _CrioCollection2.default || obj2 instanceof _CrioDate2.default)) {
        throw new TypeError('Value of argument "obj2" violates contract, expected CrioCollection | CrioDate got ' + (obj2 === null ? 'null' : (typeof obj2 === 'undefined' ? 'undefined' : _typeof(obj2)) === 'object' && obj2.constructor ? obj2.constructor.name || '[Unknown Object]' : typeof obj2 === 'undefined' ? 'undefined' : _typeof(obj2)));
    }
