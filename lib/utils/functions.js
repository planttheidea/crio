...
var _entries = require('core-js/fn/object/entries');
...
var immutableSplice = function immutableSplice(obj, index, removeNum) {
    for (var _len4 = arguments.length, newItems = Array(_len4 > 3 ? _len4 - 3 : 0), _key2 = 3; _key2 < _len4; _key2++) {
    ...
    if (!Array.isArray(newItems)) {
        throw new TypeError('Value of argument "newItems" violates contract, expected Array got ' + (newItems === null ? 'null' : (typeof newItems === 'undefined' ? 'undefined' : _typeof(newItems)) === 'object' && newItems.constructor ? newItems.constructor.name || '[Unknown Object]' : typeof newItems === 'undefined' ? 'undefined' : _typeof(newItems)));
    }
