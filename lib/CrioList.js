...
var CrioList = (function (_CrioCollection) {
    ...
    _createClass(CrioList, [{
        ...
        value: function splice(index) {
            ...
            return _ref24((0, _crioFunctions.getCrioInstance)(this, (0, _createNewCrio.createNewCrioList)(_functions.splice.apply(undefined, [this.object, index, removeNum].concat(itemsToAdd)))));
        }
